...
This function initialize the device sensor driver parameters that are defined in 'QxAutoMLUser.h'

 Here is an example of the implemetation of this function, please notice that QXAUTOMLCONFIG_SENSOR_ACCEL_ODR/QXAUTOMLCONFIG_SENSOR_ACCEL_FSR/QXAUTOMLCONFIG_SENSOR_GYRO_ODR/QXAUTOMLCONFIG_SENSOR_GYRO_FSR are defined in 'QxAutoMLUser.h': 
```
#include "QxAutoMLUser.h"
