...
#### 🔹 QxAutoMLUser.h
This file contains the sensor configurations and API declarations of the static engine library, the content of sensor configurations are automatical generated by customer's sensor config in WebUI's data collection page.
